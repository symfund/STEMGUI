...
static int _WinMain_NoClean(HINSTANCE hInstance, 
  ...
  // Load Resources
  //
  _hLogo = LoadImage(_hInst, (LPCTSTR) MAKEINTRESOURCE(IDB_LOGO), IMAGE_BITMAP,  0, 0, 0);
  ...
  if (_ahBmpDevice[0] ==0)
    _ahBmpDevice[0] = (HBITMAP)LoadImage(_hInst, (LPCTSTR)MAKEINTRESOURCE(IDB_DEVICE), IMAGE_BITMAP,  0, 0, 0);
  if (_ahBmpDevice[1] ==0)
    _ahBmpDevice[1] = (HBITMAP)LoadImage(_hInst, (LPCTSTR)MAKEINTRESOURCE(IDB_DEVICE+1), IMAGE_BITMAP,  0, 0, 0);
